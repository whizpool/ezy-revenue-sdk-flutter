...
public class EzyrevenuePlugin: NSObject, FlutterPlugin, SKProductsRequestDelegate, SKPaymentTransactionObserver {
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "ezyrevenue", binaryMessenger: registrar.messenger())
    let instance = EzyrevenuePlugin()
